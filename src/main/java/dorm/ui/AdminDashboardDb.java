...
public class AdminDashboardDb {
    ...
    // Filter controls - stored as fields for access in filtering
        ...
        resubmitBtn.setOnAction(event -> {
            ...
            for (DormApplication app : selected) {
                ...
                if (status == ApplicationStatus.PHASE_ONE_PENDING ||
                    ...
                    // Send message to student with the reason (sanitize and limit to 80 chars)
    ...
    private Tab createMessagesTab() {
        ...
        sendButton.setOnAction(event -> {
            ...
            service.sendMessage(admin.getUsername(), student.get().getUsername(), message);
            messageField.clear();
